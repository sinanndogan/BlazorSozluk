...
namespace BlazorSozluk.Infrastructure.Persistence.Context
{
    public class BlazorSozlukContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                var connStr = "Server=DESKTOP-HLG7E4T;Database=BlazorSozlukDB;User Id=sa;Password=123;";
        ...
        {
            var addedEntites = ChangeTracker.Entries().Where(a => a.State == EntityState.Added).Select(b => (BaseEntity)b.Entity);
